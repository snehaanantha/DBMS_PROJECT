...
<body id="body-pd">
        <header class="header" id="header">
            ...
            <div class="fs-3 font-weight-bold"> Update Instructor information </div>
            <div>
                Active &#128994; :
                ...
                <div> <a href="home.php" class="nav_logo"> <span class="nav_logo-name admi">
                    ...
                    <div class="nav_list"> <a href="home.php" class="nav_link "> <i class='bx bx-grid-alt nav_icon'></i>
                            ...
                            href="course.php" class="nav_link"> <i class='fas fa-book-open'></i> <span
                                class="nav_name">Courses</span> </a> <a href="instructor_admin.php" class="nav_link active"> 
                            ...
                            href="adduser.php" class="nav_link"> <i class='fas fa-user-plus'></i> <span class="nav_name">Add
                                User</span> </a>
								 <a href="admin_profile.php" class="nav_link"> <i class='fas fa-id-card-alt'></i> <span class="nav_name">Admin Profile</span>
									...
									<!-- <a class="nav_link <?php //echo ($page == 'settings')?  : '' ?>" aria-current="page" href="./?page=settings"><i class="fa fa-cogs"></i> Settings</a> -->
					</div>
...
<?php
  ...
  if(isset($_GET['delete'])){
    ...
    $query = "DELETE FROM instructor WHERE instructorid={$stdid}";
...
?>
  ...
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"></path>
        ...
        <form method="post" class="d-flex justify-content-around">
            <?php
              if(isset($_GET['update'])){ //if click on update button
                ...
                $query = "SELECT * FROM instructor,person WHERE instructor.personid=person.personid And instructorid={$stdid} ";
              ...
              <?php
                if(isset($_POST['update-btn'])){
                 ...
                 if(!empty($fn) && !empty($password)){
                  $query = "UPDATE person,instructor SET firstname='$fn', middlename='$mn', lastname='$ln', passHash='$password' WHERE instructor.personid=person.personid And instructorid=$stdid";
    ...
    <h3>
      ...
      <table class="table table-bordered  table-striped mt32 customers-list">
       ...
       <?php
       //select all query
        $query = "SELECT * FROM person,instructor Where person.personid=instructor.personid";
        ...
        if($readQuery->num_rows >0){
          ...
          while($rd=mysqli_fetch_assoc($readQuery)){
            ...
            $stdid = $rd['InstructorID']; // keeping data from db table to variable
            $fn=$rd['FirstName'];
            $mn=$rd['MiddleName'];
            $ln=$rd['LastName'];
            $username = $fn." ".$mn." ".$ln;
       ...
       <tr>
         ...
         <td><a href="instructor_admin.php?update=<?php echo"$stdid" ?>" >
  ...
  <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"></path>
         ...
         <td><a href="instructor_admin.php?delete=<?php echo"$stdid" ?>" >
